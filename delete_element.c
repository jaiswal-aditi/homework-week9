...
3. Display output as:
    The new array is: <array elements separated by a single space>
4. Use the input/output prompts as suggested in the pdf.
5. Remember that array index starts from 0.

Example:
If the original array is -> 6 7 8 9 10
--> delete element at position 2 (element: 8)
The new array is: 6 7 9 10
*/
